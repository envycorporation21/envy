...
<header class="main_header">
  <div class="row">
    <div class="content"> <a class="logo" href="#">ENVY</a>
...
<div class="carousel fade-carousel slide" data-ride="carousel" data-interval="2000" id="bs-carousel">
  ...
  <div class="carousel-inner">
    <div class="item slides active">
      ...
      <div class="hero">
        <hgroup>
            <h1>EN<span>VY</span></h1>        
            <h3>Welcome to envy company</h3>
        </hgroup>
        <button class="btn btn-hero btn-lg" role="button">Selengkapnya</button>
      </div>
    </div>
    <div class="item slides">
      ...
      <div class="hero">        
        <hgroup>
            <h1>We are <span>Profesional</span></h1>        
            <h3>Kami akan melayani semua permintaan anda</h3>
        </hgroup>       
        <button class="btn btn-hero btn-lg" role="button">Selengkapnya</button>
      </div>
    </div>
    <div class="item slides">
      ...
      <div class="hero">        
        <hgroup>
            ...
            <h3>Apapun bisa kami lakukan asal dibayar</h3>
        </hgroup>
        <button class="btn btn-hero btn-lg" role="button">Selengkapnya</button>
      </div>
    </div>
      ...
      <div class="service_section wow bounceInLeft animated">
          <div class="col-md-3">
            <div class="single_service">        
              ...
              <p>Layanan kami mudah untuk dijangkau bisa konsultasi terlebih dahulu via online ataupun datang secara langsung</p>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="single_service">        
              ...
              <h2>Biaya standar</h2>
              <p>Biaya murah dan pelayanan cepat tidak seperti ketika anda minta bantuan polisi</p>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="single_service">        
              ...
              <h2>Mengutamakan pelanggan</h2>
              <p>Kami akan semaksimal mungkin melakukan pelayanan kepada klien secara cepat,ramah dan kompeten</p>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="single_service">        
              ...
              <h2>Menggunakan cinta</h2>
              <p>Kami akan membuat klien nyaman dengan menyelesaikan tugas yang diberikan secara lembut</p>
            </div>
          </div>
            ...
            <div class="bs-example">
              ...
              <div class="tab-content">
                  <div id="sectionA" class="tab-pane fade in active">
                      <h3>Strategy</h3>
                      <p>Apapun bisa dilakukan asal dibayar dan jika mood sedang baik.</p>
                  </div>
                  <div id="sectionB" class="tab-pane fade">
                      <h3>Plan</h3>
                      <p>Kami menerima klien dimanapun tapi kalo luar kota klien yang membayar ongkos perjalanan.</p>
                  </div>
                  <div id="sectionC" class="tab-pane fade">
                      <h3>Mechanism</h3>
                      <p>Klien konsultasi terhadap permasalahannya ke admin lalu kita akan nego bayaran nya jika sudah sepakat langsung kami kerjakan.</p>
                  </div>
                  <div id="sectionD" class="tab-pane fade">
                      <h3>Title</h3>
                      <p>Ini gatau apaan malez ngetik.</p>
                  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="getit_section">
        <h1>Pengen jadi raja orang kaya</h1>
      </div>  
    </div>
  </div>
</div><!--  getit area end -->
    ...
    <div id="portfoliolist">
     ...
     <!-- <div class="portfolio web" data-cat="web">
      ...
      <div class="portfolio other" data-cat="other">
        <div class="portfolio-wrapper">
          <img src="img/portfolios/other/5.jpeg" alt="" />
          <div class="label">
            <div class="label-text">
              <a class="text-title">miko x olis</a>
              <span class="text-category">Other</span>
            </div>
            <div class="label-bg"></div>
          </div>
        </div>
      ...
      <div class="portfolio other" data-cat="other">
        <div class="portfolio-wrapper">
          <img src="img/portfolios/other/2.jpeg" alt="" />
          <div class="label">
            <div class="label-text">
              <a class="text-title">rara</a>
              <span class="text-category">Other</span>
            </div>
            <div class="label-bg"></div>
          </div>
      ...
      <div class="portfolio other" data-cat="other">
        <div class="portfolio-wrapper">
          <img src="img/portfolios/other/3.jpeg" alt="" />
          <div class="label">
            <div class="label-text">
              <a class="text-title">miko</a>
              <span class="text-category">Other</span>
            </div>
            <div class="label-bg"></div>
          </div>
      ...
      <div class="portfolio other" data-cat="other">
        <div class="portfolio-wrapper">
          <img src="img/portfolios/other/4.jpeg" alt="" />
          <div class="label">
            <div class="label-text">
              <a class="text-title">Rara</a>
              <span class="text-category">Other</span>
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                  <div class="panel-body">
                    Envy adalah perusahan yang diciptakan karena CEO nya malez buat nyari tempat pkl makannya bikin perusahan sendiri, dia juga keanya dapet gelar CEO termuda dan termiskin di dunia dah.Envy akan menerima jenis pekerjaan apapun asal dibayar guys ya tapi dengan syarat jika pihak kami lagi mood aja sih kalo nggak yaudah maaf kami tolak hehe.Tapi jangan diragukan lagi kinerja kami, kalo lagi niat envy bakal ngelakuin apapun untuk melayani permintaan klien nya.
                  </div>
                </div>
              </div>
              <div class="panel panel-default">
    ...
    <div class="row">
      <div class="blog_section">
          ...
          <div class="single_blog col-md-4 slider-content">
            <a href="https://olisdragneel19.github.io/gluttony/">
                <img src="img/admin.png" alt="">
                <div class="slider-text">
                  <h3>Web Pribadi admin ENVY</h3>
                  <p> <i class="fa fa-user"></i> BY Olis Dragneel <i class="fa fa-clock-o"></i> 15 Februari, 2023</p>
                  <p>Nih buat yang mau tau siapa yang bikin web gk jelas ini.</p>
                </div>
            </a>
          </div> 
          <div class="single_blog col-md-4 slider-content">
            <a href="https://www.instagram.com/olisdragneel19?r=nametag">
                <img src="img/2.jpg" alt="">
                <div class="slider-text">
                  <h3>Akun instagram ku</h3>
                  <p> <i class="fa fa-user"></i> By Olis Dragneel <i class="fa fa-clock-o"></i> 16 Februari, 2023</p>                  
                  <p>Instagram nya admin nih follow guys ya.</p>
                </div>
            </a>
          </div> 
  ...
  <div class="container">
    <div class="row">
      <div class="contact_section">
          <h1>Contact us</h1>
          <p>Kolom email blom jadi buat pajangan doank guys ya kalo mau konsultasi ke itu aja contact info.</p>
                    ...
                    <div class="col-md-6">
                        <div class="contact_text">
                            <p>Yang mau nanya bisa langsung konsultasi aja CEO nya masih 18th kok gausah formal guys.</p>
                            <h3>contact info</h3>
                            <ul class="contact_info">
                                <li>olisdragneel28@gmail.com</li>
                                <li>Cirebon Selatan, Indonesia</li>
                                <li>+62 82217433746,</li>
                            </ul>
                            <h3>follow us</h3>
                            <ul class="contact_social">
                                <a href="https://www.facebook.com/olis.dragneel.19"><li><i class="fb fa fa-facebook-square"></i></li></a>
                                <a href="#"><li><i class="tw fa fa-twitter-square"></i></li></a>
                                <a href="#"><li><i class="rss fa fa-rss-square"></i></li></a>
                                <a href="#"><li><i class="ig fa fa-instagram-square"></i></li></a>
                            </ul>                            
                        </div>
                    </div>
      </div>
